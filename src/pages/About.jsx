        ...
        <>
         <h1 className='text-4xl mb-4'>Github Finder</h1>
            <p className='mb-4 text-2xl font-light'>
                ...
                Udemy course by
                <strong>
                    <a href='https://traversymedia.com' target='_blank' rel="noopener noreferrer"> Brad Traversy</a>
                </strong>
                .
            </p>
            ...
            <p className='text-lg text-gray-400'>
                Layout By: 
                <a className='text-white' href='https://twitter.com/hassibmoddasser'> Hassib Moddasser
                </a>
            </p>
        </>
    )
